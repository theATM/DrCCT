...
parser.add_argument('--test', action='store_true', default=False,
                   help='Test the trained model (without training)')
...
group.add_argument('--cifar', action='store_true', default=False,
                   help='Use Cifar-100 dataset')
